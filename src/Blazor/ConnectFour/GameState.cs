...
public class GameState
{
	...
	/// <summary>Indicate whether a player has won, the game is a tie, or game in ongoing.</summary>
	...
	/// <summary>The player whose turn it is.  By default, player 1 starts first.</summary>
	public int PlayerTurn => TheBoard.Count( x => x != 0 ) % 2 + 1;

	/// <summary>Number of turns completed and pieces played so far in the game.</summary>
	...
	/// <summary>Check the state of the board for a winning scenario.</summary>
	...
	/// <summary>Takes the current turn and places a piece in the 0-indexed column requested.</summary>
